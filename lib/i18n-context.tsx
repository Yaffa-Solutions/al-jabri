...
const translationsEn: Record<string, string> = {
  ...
  'blog.editor.clickToUpload': 'Click to upload cover image',
  'blog.editor.fileFormat': 'PNG, JPG, GIF up to 10MB',
  'blog.editor.translating': 'Translating...',
  'blog.editor.autoTranslateToArabic': 'Auto-Translate to Arabic',
  'blog.editor.autoTranslateToEnglish': 'Auto-Translate to English',

  // Dashboard
  'dashboard.title': 'Dashboard',
  'dashboard.welcome': 'Welcome back',
  'dashboard.adminPanel': 'Al-Jabri Admin',
  ...
  'dashboard.nav.rooms': 'Rooms',
  'dashboard.nav.blogs': 'Blogs',
  ...
  'dashboard.stats.totalHotels': 'Total Hotels',
  'dashboard.stats.totalBlogs': 'Total Blogs',

  // Dashboard Quick Actions
  'dashboard.quickActions': 'Quick Actions',
  'dashboard.manageBookings': 'Manage Bookings',
  'dashboard.manageBookingsDesc': 'View and manage all hotel bookings',
  'dashboard.manageHotels': 'Manage Hotels',
  'dashboard.manageHotelsDesc': 'Add or edit hotel information',
  'dashboard.manageBlogs': 'Manage Blogs',
  'dashboard.manageBlogsDesc': 'Create and publish blog posts',

  // Blogs Management
  'dashboard.blogs.title': 'Blogs Management',
  'dashboard.blogs.subtitle': 'Create and manage blog posts',
  'dashboard.blogs.createNew': 'Create New Post',
  'dashboard.blogs.totalPosts': 'Total Posts',
  'dashboard.blogs.published': 'Published',
  'dashboard.blogs.drafts': 'Drafts',
  'dashboard.blogs.edit': 'Edit',
  'dashboard.blogs.preview': 'Preview',
  'dashboard.blogs.publish': 'Publish',
  'dashboard.blogs.unpublish': 'Unpublish',
  'dashboard.blogs.delete': 'Delete',
  'dashboard.blogs.draft': 'Draft',
  'dashboard.blogs.unknown': 'Unknown',
  'dashboard.blogs.noPosts': 'No blog posts found. Create your first post to get started.',
  'dashboard.blogs.confirmDelete': 'Are you sure you want to delete this blog post? This action cannot be undone.',
  'dashboard.blogs.confirmPublish': 'Are you sure you want to publish this blog post?',
  'dashboard.blogs.confirmUnpublish': 'Are you sure you want to unpublish this blog post?',
  'dashboard.blogs.deleteFailed': 'Failed to delete blog',
  'dashboard.blogs.publishFailed': 'Failed to publish blog',
  'dashboard.blogs.unpublishFailed': 'Failed to unpublish blog',

  // Bookings Management
  'dashboard.bookings.title': 'Bookings Management',
  'dashboard.bookings.subtitle': 'View and manage all hotel bookings',
  'dashboard.bookings.totalBookings': 'Total Bookings',
  'dashboard.bookings.confirmed': 'Confirmed',
  'dashboard.bookings.pending': 'Pending',
  'dashboard.bookings.cancelled': 'Cancelled',
  'dashboard.bookings.bookingId': 'Booking ID',
  'dashboard.bookings.guest': 'Guest',
  'dashboard.bookings.hotelRoom': 'Hotel & Room',
  'dashboard.bookings.checkInOut': 'Check-in/out',
  'dashboard.bookings.guests': 'Guests',
  'dashboard.bookings.totalPrice': 'Total Price',
  'dashboard.bookings.status': 'Status',

  // Hotels Management
  'dashboard.hotels.title': 'Hotels Management',
  'dashboard.hotels.subtitle': 'Manage hotel listings and information',
  'dashboard.hotels.addNew': 'Add New Hotel',
  'dashboard.hotels.rooms': 'rooms',
  'dashboard.hotels.edit': 'Edit',
  'dashboard.hotels.delete': 'Delete',
  'dashboard.hotels.noHotels': 'No hotels found. Add your first hotel to get started.',
  'dashboard.hotels.more': 'more',
  'dashboard.hotels.createHotel': 'Create New Hotel',
  'dashboard.hotels.editHotel': 'Edit Hotel',
  'dashboard.hotels.saveDraft': 'Save Draft',
  'dashboard.hotels.publish': 'Publish',
  'dashboard.hotels.unpublish': 'Unpublish',
  'dashboard.hotels.preview': 'Preview',
  'dashboard.hotels.mainImage': 'Main Image',
  'dashboard.hotels.clickToUpload': 'Click to upload image',
  'dashboard.hotels.additionalDetails': 'Additional Details',
  'dashboard.hotels.starRating': 'Star Rating',
  'dashboard.hotels.checkInTime': 'Check-in Time',
  'dashboard.hotels.checkOutTime': 'Check-out Time',
  'dashboard.hotels.availability': 'Availability Status',
  'dashboard.hotels.phone': 'Phone',
  'dashboard.hotels.email': 'Email',
  'dashboard.hotels.website': 'Website',
  'dashboard.hotels.postalCode': 'Postal Code',
  'dashboard.hotels.latitude': 'Latitude',
  'dashboard.hotels.longitude': 'Longitude',
  'dashboard.hotels.featuredHotel': 'Mark as Featured Hotel',
  'dashboard.hotels.facilitiesDescription': 'Select available facilities and add descriptions if needed.',
  'dashboard.hotels.policiesDescription': 'Add hotel policies in both English and Arabic.',
  'dashboard.hotels.addPolicy': 'Add Policy',
  'dashboard.hotels.noPolicies': 'No policies added yet. Click "Add Policy" to create one.',
  'dashboard.hotels.galleryDescription': 'Upload images and videos for the hotel gallery.',
  'dashboard.hotels.uploadMedia': 'Upload Media',
  'dashboard.hotels.noMedia': 'No media uploaded yet. Click "Upload Media" to add images or videos.',
  'dashboard.hotels.tab.basic': 'Basic Info',
  'dashboard.hotels.tab.facilities': 'Facilities',
  'dashboard.hotels.tab.policies': 'Policies',
  'dashboard.hotels.tab.gallery': 'Gallery',
  'dashboard.hotels.tab.seo': 'SEO',
  'dashboard.hotels.totalHotels': 'Total Hotels',
  'dashboard.hotels.publishedHotels': 'Published',
  'dashboard.hotels.draftHotels': 'Drafts',
  'dashboard.hotels.featuredHotels': 'Featured',
  'dashboard.hotels.published': 'Published',
  'dashboard.hotels.draft': 'Draft',
  'dashboard.hotels.featured': 'Featured',
  'dashboard.hotels.feature': 'Feature',
  'dashboard.hotels.unfeature': 'Unfeature',
  'dashboard.hotels.confirmDelete': 'Are you sure you want to delete this hotel? This action cannot be undone.',
  'dashboard.hotels.confirmPublish': 'Are you sure you want to publish this hotel?',
  ...
  // Rooms Management
  'dashboard.rooms.title': 'Rooms Management',
  'dashboard.rooms.subtitle': 'Manage hotel rooms and their details',
  'dashboard.rooms.addNew': 'Add New Room',
  'dashboard.rooms.totalRooms': 'Total Rooms',
  'dashboard.rooms.availableRooms': 'Available Rooms',
  'dashboard.rooms.occupiedRooms': 'Occupied Rooms',
  'dashboard.rooms.edit': 'Edit',
  'dashboard.rooms.delete': 'Delete',
  'dashboard.rooms.noRooms': 'No rooms found. Create your first room to get started.',
  'dashboard.rooms.createRoom': 'Create New Room',
  'dashboard.rooms.editRoom': 'Edit Room',
  'dashboard.rooms.updateRoom': 'Update Room',
  'dashboard.rooms.confirmDelete': 'Are you sure you want to delete this room? This action cannot be undone.',
  'dashboard.rooms.deleteFailed': 'Failed to delete room',
  'dashboard.rooms.updateFailed': 'Failed to update room',
  'dashboard.rooms.available': 'available',
  'dashboard.rooms.guests': 'guests',
  'dashboard.rooms.perNight': 'per night',

  // Users Management
  'dashboard.users.title': 'User Management',
  'dashboard.users.subtitle': 'Manage user accounts and permissions',
  'dashboard.users.user': 'User',
  'dashboard.users.email': 'Email',
  'dashboard.users.role': 'Role',
  'dashboard.users.joined': 'Joined',
  'dashboard.users.actions': 'Actions',
  'dashboard.users.noName': 'No name',
  'dashboard.users.you': '(You)',
  'dashboard.users.deleteUser': 'Delete user',
  'dashboard.users.roleUser': 'User',
  'dashboard.users.roleAdmin': 'Admin',
  'dashboard.users.roleSuperAdmin': 'Super Admin',
  'dashboard.users.confirmRoleChange': 'Are you sure you want to change this user\'s role to',
  'dashboard.users.confirmDelete': 'Are you sure you want to delete this user? This action cannot be undone.',
  'dashboard.users.updateFailed': 'Failed to update user role',
  'dashboard.users.deleteFailed': 'Failed to delete user',

  // Activities
  'dashboard.activities.title': 'Activity Logs',
  'dashboard.activities.subtitle': 'Monitor user actions and system activities',
  'dashboard.activities.unknownUser': 'Unknown User',
  'dashboard.activities.noActivities': 'No activities recorded yet.',
  'dashboard.activities.showingLatest': 'Showing the latest 100 activities',
  'dashboard.activities.ip': 'IP',
};
...
const translationsAr: Record<string, string> = {
  ...
  'blog.editor.clickToUpload': 'انقر لتحميل الصورة الرئيسية',
  'blog.editor.fileFormat': 'PNG، JPG، GIF حتى 10 ميجابايت',
  'blog.editor.translating': 'جاري الترجمة...',
  'blog.editor.autoTranslateToArabic': 'ترجمة تلقائية إلى العربية',
  'blog.editor.autoTranslateToEnglish': 'ترجمة تلقائية إلى الإنجليزية',

  // Dashboard
  'dashboard.title': 'لوحة التحكم',
  'dashboard.welcome': 'مرحباً بعودتك',
  'dashboard.adminPanel': 'إدارة الجابر',
  'dashboard.signOut': 'تسجيل الخروج',

  // Dashboard Navigation
  'dashboard.nav.dashboard': 'لوحة التحكم',
  'dashboard.nav.bookings': 'الحجوزات',
  'dashboard.nav.hotels': 'الفنادق',
  'dashboard.nav.rooms': 'الغرف',
  'dashboard.nav.blogs': 'المدونات',
  'dashboard.nav.users': 'المستخدمين',
  'dashboard.nav.activities': 'الأنشطة',

  // Dashboard Stats
  'dashboard.stats.totalUsers': 'إجمالي المستخدمين',
  'dashboard.stats.totalBookings': 'إجمالي الحجوزات',
  'dashboard.stats.totalHotels': 'إجمالي الفنادق',
  'dashboard.stats.totalBlogs': 'إجمالي المدونات',

  // Dashboard Quick Actions
  'dashboard.quickActions': 'إجراءات سريعة',
  'dashboard.manageBookings': 'إدارة الحجوزات',
  'dashboard.manageBookingsDesc': 'عرض وإدارة جميع حجوزات الفنادق',
  'dashboard.manageHotels': 'إدارة الفنادق',
  'dashboard.manageHotelsDesc': 'إضافة أو تعديل معلومات الفندق',
  'dashboard.manageBlogs': 'إدارة المدونات',
  'dashboard.manageBlogsDesc': 'إنشاء ونشر مقالات المدونة',

  // Blogs Management
  'dashboard.blogs.title': 'إدارة المدونات',
  'dashboard.blogs.subtitle': 'إنشاء وإدارة مقالات المدونة',
  'dashboard.blogs.createNew': 'إنشاء مقال جديد',
  'dashboard.blogs.totalPosts': 'إجمالي المقالات',
  'dashboard.blogs.published': 'المنشورة',
  'dashboard.blogs.drafts': 'المسودات',
  'dashboard.blogs.edit': 'تعديل',
  'dashboard.blogs.preview': 'معاينة',
  'dashboard.blogs.publish': 'نشر',
  'dashboard.blogs.unpublish': 'إلغاء النشر',
  'dashboard.blogs.delete': 'حذف',
  'dashboard.blogs.draft': 'مسودة',
  'dashboard.blogs.unknown': 'غير معروف',
  'dashboard.blogs.noPosts': 'لم يتم العثور على مقالات. أنشئ مقالك الأول للبدء.',
  'dashboard.blogs.confirmDelete': 'هل أنت متأكد من حذف هذا المقال؟ هذا الإجراء لا يمكن التراجع عنه.',
  'dashboard.blogs.confirmPublish': 'هل أنت متأكد من نشر هذا المقال؟',
  'dashboard.blogs.confirmUnpublish': 'هل أنت متأكد من إلغاء نشر هذا المقال؟',
  'dashboard.blogs.deleteFailed': 'فشل حذف المقال',
  'dashboard.blogs.publishFailed': 'فشل نشر المقال',
  'dashboard.blogs.unpublishFailed': 'فشل إلغاء نشر المقال',

  // Bookings Management
  'dashboard.bookings.title': 'إدارة الحجوزات',
  'dashboard.bookings.subtitle': 'عرض وإدارة جميع حجوزات الفنادق',
  'dashboard.bookings.totalBookings': 'إجمالي الحجوزات',
  'dashboard.bookings.confirmed': 'المؤكدة',
  'dashboard.bookings.pending': 'قيد الانتظار',
  'dashboard.bookings.cancelled': 'الملغاة',
  'dashboard.bookings.bookingId': 'رقم الحجز',
  'dashboard.bookings.guest': 'الضيف',
  'dashboard.bookings.hotelRoom': 'الفندق والغرفة',
  'dashboard.bookings.checkInOut': 'الوصول/المغادرة',
  'dashboard.bookings.guests': 'الضيوف',
  'dashboard.bookings.totalPrice': 'السعر الإجمالي',
  'dashboard.bookings.status': 'الحالة',

  // Hotels Management
  'dashboard.hotels.title': 'إدارة الفنادق',
  'dashboard.hotels.subtitle': 'إدارة قوائم الفنادق والمعلومات',
  'dashboard.hotels.addNew': 'إضافة فندق جديد',
  'dashboard.hotels.rooms': 'غرفة',
  'dashboard.hotels.edit': 'تعديل',
  'dashboard.hotels.delete': 'حذف',
  'dashboard.hotels.noHotels': 'لم يتم العثور على فنادق. أضف فندقك الأول للبدء.',
  'dashboard.hotels.more': 'المزيد',
  'dashboard.hotels.createHotel': 'إنشاء فندق جديد',
  'dashboard.hotels.editHotel': 'تعديل الفندق',
  'dashboard.hotels.saveDraft': 'حفظ كمسودة',
  'dashboard.hotels.publish': 'نشر',
  'dashboard.hotels.unpublish': 'إلغاء النشر',
  'dashboard.hotels.preview': 'معاينة',
  'dashboard.hotels.mainImage': 'الصورة الرئيسية',
  'dashboard.hotels.clickToUpload': 'انقر لتحميل الصورة',
  'dashboard.hotels.additionalDetails': 'تفاصيل إضافية',
  'dashboard.hotels.starRating': 'تصنيف النجوم',
  'dashboard.hotels.checkInTime': 'وقت تسجيل الوصول',
  'dashboard.hotels.checkOutTime': 'وقت تسجيل المغادرة',
  'dashboard.hotels.availability': 'حالة التوفر',
  'dashboard.hotels.phone': 'الهاتف',
  'dashboard.hotels.email': 'البريد الإلكتروني',
  'dashboard.hotels.website': 'الموقع الإلكتروني',
  'dashboard.hotels.postalCode': 'الرمز البريدي',
  'dashboard.hotels.latitude': 'خط العرض',
  'dashboard.hotels.longitude': 'خط الطول',
  'dashboard.hotels.featuredHotel': 'تمييز كفندق مميز',
  'dashboard.hotels.facilitiesDescription': 'اختر المرافق المتوفرة وأضف أوصافًا إذا لزم الأمر.',
  'dashboard.hotels.policiesDescription': 'أضف سياسات الفندق بالإنجليزية والعربية.',
  'dashboard.hotels.addPolicy': 'إضافة سياسة',
  'dashboard.hotels.noPolicies': 'لم تتم إضافة سياسات بعد. انقر على "إضافة سياسة" لإنشاء واحدة.',
  'dashboard.hotels.galleryDescription': 'قم بتحميل الصور ومقاطع الفيديو لمعرض الفندق.',
  'dashboard.hotels.uploadMedia': 'تحميل وسائط',
  'dashboard.hotels.noMedia': 'لم يتم تحميل وسائط بعد. انقر على "تحميل وسائط" لإضافة صور أو فيديو.',
  'dashboard.hotels.tab.basic': 'المعلومات الأساسية',
  'dashboard.hotels.tab.facilities': 'المرافق',
  'dashboard.hotels.tab.policies': 'السياسات',
  'dashboard.hotels.tab.gallery': 'المعرض',
  'dashboard.hotels.tab.seo': 'تحسين محركات البحث',
  'dashboard.hotels.totalHotels': 'إجمالي الفنادق',
  'dashboard.hotels.publishedHotels': 'المنشورة',
  'dashboard.hotels.draftHotels': 'المسودات',
  'dashboard.hotels.featuredHotels': 'المميزة',
  'dashboard.hotels.published': 'منشور',
  'dashboard.hotels.draft': 'مسودة',
  'dashboard.hotels.featured': 'مميز',
  'dashboard.hotels.feature': 'تمييز',
  'dashboard.hotels.unfeature': 'إلغاء التمييز',
  'dashboard.hotels.confirmDelete': 'هل أنت متأكد من حذف هذا الفندق؟ هذا الإجراء لا يمكن التراجع عنه.',
  'dashboard.hotels.confirmPublish': 'هل أنت متأكد من نشر هذا الفندق؟',
  ...
  // Rooms Management
  'dashboard.rooms.title': 'إدارة الغرف',
  'dashboard.rooms.subtitle': 'إدارة غرف الفنادق وتفاصيلها',
  'dashboard.rooms.addNew': 'إضافة غرفة جديدة',
  'dashboard.rooms.totalRooms': 'إجمالي الغرف',
  'dashboard.rooms.availableRooms': 'الغرف المتاحة',
  'dashboard.rooms.occupiedRooms': 'الغرف المشغولة',
  'dashboard.rooms.edit': 'تعديل',
  'dashboard.rooms.delete': 'حذف',
  'dashboard.rooms.noRooms': 'لم يتم العثور على غرف. أنشئ غرفتك الأولى للبدء.',
  'dashboard.rooms.createRoom': 'إنشاء غرفة جديدة',
  'dashboard.rooms.editRoom': 'تعديل الغرفة',
  'dashboard.rooms.updateRoom': 'تحديث الغرفة',
  'dashboard.rooms.confirmDelete': 'هل أنت متأكد من حذف هذه الغرفة؟ هذا الإجراء لا يمكن التراجع عنه.',
  'dashboard.rooms.deleteFailed': 'فشل حذف الغرفة',
  'dashboard.rooms.updateFailed': 'فشل تحديث الغرفة',
  'dashboard.rooms.available': 'متاح',
  'dashboard.rooms.guests': 'ضيوف',
  'dashboard.rooms.perNight': 'لليلة',

  // Users Management
  'dashboard.users.title': 'إدارة المستخدمين',
  'dashboard.users.subtitle': 'إدارة حسابات المستخدمين والصلاحيات',
  'dashboard.users.user': 'المستخدم',
  'dashboard.users.email': 'البريد الإلكتروني',
  'dashboard.users.role': 'الدور',
  'dashboard.users.joined': 'تاريخ الانضمام',
  'dashboard.users.actions': 'الإجراءات',
  'dashboard.users.noName': 'بدون اسم',
  'dashboard.users.you': '(أنت)',
  'dashboard.users.deleteUser': 'حذف المستخدم',
  'dashboard.users.roleUser': 'مستخدم',
  'dashboard.users.roleAdmin': 'مدير',
  'dashboard.users.roleSuperAdmin': 'مدير عام',
  'dashboard.users.confirmRoleChange': 'هل أنت متأكد من تغيير دور هذا المستخدم إلى',
  'dashboard.users.confirmDelete': 'هل أنت متأكد من حذف هذا المستخدم؟ هذا الإجراء لا يمكن التراجع عنه.',
  'dashboard.users.updateFailed': 'فشل تحديث دور المستخدم',
  'dashboard.users.deleteFailed': 'فشل حذف المستخدم',

  // Activities
  'dashboard.activities.title': 'سجلات الأنشطة',
  'dashboard.activities.subtitle': 'مراقبة إجراءات المستخدمين وأنشطة النظام',
  'dashboard.activities.unknownUser': 'مستخدم غير معروف',
  'dashboard.activities.noActivities': 'لم يتم تسجيل أي أنشطة بعد.',
  'dashboard.activities.showingLatest': 'عرض آخر 100 نشاط',
  'dashboard.activities.ip': 'عنوان IP',
};
