...
const translationsEn: Record<string, string> = {
  ...
  "blogs.arabicTitle": "مدونتنا",
  "blogs.subtitle": "Insights, tips, and stories from the world of hospitality management",
  ...
  "blog.editor.enterMetaDesc": "Brief description for search engines (160 characters max)",
