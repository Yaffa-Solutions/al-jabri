        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {publishedBlogs.length > 0 ? (
              ...
              <Link key={blog.id} href={`/blogs/${blog.id}`}>
                <Card className="bg-white border-[#E3D6C7] hover:shadow-xl transition-shadow overflow-hidden h-full">
                  ...
                  <CardHeader>
                    ...
                    <CardTitle
                      className="text-[#324557] hover:text-[#B99B75] transition-colors"
                      dir={locale === 'ar' ? 'rtl' : 'ltr'}
                    >
                      {locale === 'en' ? blog.title : blog.titleAr}
                    </CardTitle>
                    <CardDescription
                      className="text-[#5F83A4] line-clamp-3"
                      dir={locale === 'ar' ? 'rtl' : 'ltr'}
                    >
                  ...
                  <CardContent>
                    <Button
                      variant="ghost"
                      className="text-[#B99B75] hover:text-[#CEB89E] hover:bg-[#F7F4F0] gap-2 p-0"
                    >
                      {t('blogs.readMore')}
            ...
            <div className="col-span-full text-center py-12">
              <p className="text-[#5F83A4] text-lg">{t('blogs.noBlogs')}</p>
            </div>
          )}
        </div>
      </div>
