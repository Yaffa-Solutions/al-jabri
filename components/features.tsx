    ...
    <section className="py-16 bg-[#E3D6C7]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#324557] mb-4">
            {t('whyChooseUs')}
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="text-center hover:shadow-lg transition-shadow duration-300 bg-card"
            >
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#324557] mb-3">
                  {feature.title}
                </h3>

                <p className="text-[#48647E] text-pretty">
                  {feature.description}
                </p>
              </CardContent>
            </Card>
